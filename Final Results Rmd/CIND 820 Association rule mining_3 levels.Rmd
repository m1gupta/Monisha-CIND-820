...
```{r}
drops_1 <- c("Year","Month","Class", "Year_Month")
...
rules_over_1 <- apriori(df_over_trans,
                 parameter = list(supp = 0.01, conf = 0.55), appearance = list(rhs=c("Total_Bene_Hosp=low")))

rules_over_2 <- apriori(df_over_trans,
                 parameter = list(supp = 0.01, conf = 0.55), appearance = list(rhs=c("Total_Bene_Hosp=middle")))

rules_over_3 <- apriori(df_over_trans,
                 parameter = list(supp = 0.01, conf = 0.55), appearance = list(rhs=c("Total_Bene_Hosp=high")))
Sys.time()
```

```{r}
inspect(rules_over_1)
```
...
```
```{r}
inspect(rules_over_3)
```
```{r}
#ruleExplorer(rules_over_1)
```
